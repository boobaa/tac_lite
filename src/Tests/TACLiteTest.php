...
class TACLiteTest extends WebTestBase {
   ...
   * @var array
   */
  public static $modules = array('node', 'taxonomy', 'tac_lite'); // TODO: field_ui?

  /**
   * A node visible for everyone.
   *
   * @var \Drupal\node\NodeInterface
   */
  protected $visibleNode;

  /**
   * A node visible only for authenticated users.
   *
   * @var \Drupal\node\NodeInterface
   */
  protected $authenticatedNode;

  /**
   * A user with permission to view a node accessible only for authenticated
   * users.
   *
   * @var object
   */
  ...
  protected function setUp() {
     ...
     *   - 'Everyone'
     *   - 'Authenticated'
     * - Enable TAC Lite for this vocabulary.
     * - Create a TAC Lite Scheme that grants 'view' permission:
     *   - for anonymous users: only for the 'Everyone' term,
     *   - for authenticated users: both for the 'Everyone' and 'Authenticated'
     *     terms.
     ...
     * - Create /node/1 titled 'For everyone', with the 'Everyone' term.
     * - Create /node/2 titled 'For authenticated', with the 'Authenticated'
     *   term.
     *
     * Test plan - actual tests.
     * - Visit '/node/1' as anonymous - should return 200.
     * - Visit '/node/1' as authenticated - should return 200.
     * - Visit '/node/2' as anonymous - should return 403.
     * - Visit '/node/2' as authenticated - should return 200.
     */
